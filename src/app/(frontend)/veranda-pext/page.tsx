...
export const metadata = {
  title: 'Pext veranda | Veranda Zeeland',
  description:
    'De Pext houten veranda combineert robuust Douglas- of larikshout met slanke aluminium beglazingsprofielen. Geïsoleerd of ongeïsoleerd, en uit te breiden met een lichtstraat.',
}
...
export default async function VerandaPextPage() {
  const c = await getContent('veranda-pext')
  ...
  return (
    <div className="max-w-[1280px] mx-auto bg-cream">
      ...
      <RelatedModels slug="veranda-pext" title={c.othersTitle} override={c.otherModels} />
