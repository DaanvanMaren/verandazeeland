...
export const metadata = {
  title: 'Knikarmschermen | Veranda Zeeland',
  description:
    'Knikarmschermen: schaduw precies waar u het wilt, zonder steunpalen. Tot 7,5 meter breed, met windsensor en Smart Home-bediening, op maat voor terras en gevel.',
}
...
export default async function ZonweringKnikarmschermenPage() {
  const c = await getContent('zonwering-knikarmschermen')
    ...
    <div className="max-w-[1280px] mx-auto bg-cream">
      ...
      <div className="grid grid-cols-2 max-[820px]:grid-cols-1 gap-[44px] pt-[24px] px-[40px] pb-[56px] max-[600px]:px-[16px] items-center">
        <div>
          ...
          <div className="flex gap-[14px] flex-wrap">
            ...
            <a className="btn-y bg-gold text-navy font-extrabold text-[15px] py-[15px] px-[26px] rounded-full" href="/zonwering">{c.heroSecondaryCta}</a>
          </div>
        </div>
      ...
      <div className="grid grid-cols-[1.15fr_1fr] max-[820px]:grid-cols-1 gap-[48px] pt-[20px] px-[40px] pb-[56px] max-[600px]:px-[16px] items-center">
        <div>
          ...
          <ul className="list-none m-0 p-0 flex flex-col gap-[10px] text-[15.5px] text-slate">
      ...
      <div className="pt-[40px] px-[40px] pb-[56px] max-[600px]:px-[16px] bg-line">
        <h2 className="font-display font-extrabold text-[30px] mb-[30px] tracking-[-1px]">{c.featuresTitle}</h2>
      ...
      <div className="bg-gold p-[56px] max-[600px]:p-[26px] my-[40px] mx-[40px] max-[600px]:mx-[16px] rounded-[26px] text-center">
        ...
        {c.ctaText && <p className="text-[16.5px] text-slate-dark mx-auto mb-[24px] max-w-[520px]">{c.ctaText}</p>}
