...
export const metadata = {
  title: 'Palazzo veranda | Veranda Zeeland',
  description:
    'De Palazzo veranda met roterend lamellendak: zelf zon en schaduw doseren, waterdicht bij regen en een strak kubistisch design. Ook leverbaar als Sqope met glasdak.',
}
...
export default async function VerandaPalazzoPage() {
  const c = await getContent('veranda-palazzo')
  ...
  return (
    <div className="max-w-[1280px] mx-auto bg-cream">
      ...
      <RelatedModels slug="veranda-palazzo" title={c.othersTitle} override={c.otherModels} />
