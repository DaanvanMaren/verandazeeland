...
export default async function ZonweringBovendakPage() {
  const c = await getContent('zonwering-bovendak')
  ...
  return (
    <div style={{ maxWidth: 1280, margin: '0 auto', background: '#f6f0e6' }}>
      ...
      <div style={{ padding: '20px 40px 0', fontSize: 13, color: '#8a94a0' }}>
        ...
        <span style={{ color: '#082a52', fontWeight: 600 }}>Bovendakzonwering</span>
      </div>
