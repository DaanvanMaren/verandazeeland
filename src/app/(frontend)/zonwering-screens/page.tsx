...
export default async function ZonweringScreensPage() {
  const c = await getContent('zonwering-screens')
  ...
  return (
    <div style={{ maxWidth: 1280, margin: '0 auto', background: '#f6f0e6' }}>
      ...
      <div style={{ padding: '20px 40px 0', fontSize: 13, color: '#8a94a0' }}>
        <a className="nav-a" href="/">Home</a> › <a className="nav-a" href="/zonwering">Zonwering</a> › <span style={{ color: '#082a52', fontWeight: 600 }}>Screens</span>
      </div>
