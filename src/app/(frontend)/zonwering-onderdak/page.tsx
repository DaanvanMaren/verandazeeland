...
export const metadata = { title: 'Onderdakzonwering | Veranda Zeeland' }
...
export default async function ZonweringOnderdakPage() {
  const c = await getContent('zonwering-onderdak')
  ...
  return (
    <div style={{ maxWidth: 1280, margin: '0 auto', background: '#f6f0e6' }}>
      ...
      <div style={{ padding: '20px 40px 0', fontSize: 13, color: '#8a94a0' }}>
        <a className="nav-a" href="/">Home</a> › <a className="nav-a" href="/zonwering">Zonwering</a> ›{' '}
        <span style={{ color: '#082a52', fontWeight: 600 }}>{c.heroTitle}</span>
      </div>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 44, padding: '24px 40px 56px', alignItems: 'center' }}>
        <div>
          ...
          <div style={{ display: 'flex', gap: 14, flexWrap: 'wrap' }}>
            ...
            <a className="btn-y" href="/zonwering" style={{ background: '#ffcf33', color: '#082a52', fontWeight: 800, fontSize: 15, padding: '15px 26px', borderRadius: 999 }}>{c.heroSecondaryCta}</a>
          </div>
        </div>
